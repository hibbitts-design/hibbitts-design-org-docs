...
> [!TIP]
> **New: Grav Helios Course Hub** – The successor to the Open Course Hub and Open MultiCourse Hub, now built on the Grav Premium Helios theme. A single installation supports one or more courses with automatic course switching, context-aware search, visual course cards, and rich content  embedding (H5P, iFrames, Google Slides) – no custom design or coding required. [Learn more](https://github.com/hibbitts-design/grav-skeleton-helios-course-hub/blob/main/README.md).
