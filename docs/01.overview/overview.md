...
>[!TIP]
>**New: Grav Helios Course Hub** – A modern companion site for one or more courses, built on the Grav Premium Helios theme. Highlights include visual course cards, context-aware search, automatic course switching, Git Sync for open collaborative authoring, and rich content embedding (H5P, iFrames, Google Slides) – no custom design or coding required. [Learn more](https://github.com/hibbitts-design/grav-skeleton-helios-course-hub/blob/main/README.md).
