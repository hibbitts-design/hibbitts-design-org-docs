...
This site contains documentation about my initial open-source Grav projects; [Grav Open Course/MultiCourse Hub](../02.opencoursehub/overview.md), [Grav Open Publishing Space](../04.openpublishingspace/overview.md) and [Grav Learn2 with GitSync](../05.learn2withgitsync/overview.md).

> [!NOTE]
> **Grav Helios Course Hub is the successor to the Open Course Hub and MultiCourse Course Hub.** Built on the Grav Premium Helios theme, it unifies single and multi-course support into one installation with a significantly more refined visual experience, with automatic single or multi-course setup, context-aware search, and visual course cards. [Grav Helios Course Hub on GitHub](https://github.com/hibbitts-design/grav-skeleton-helios-course-hub).
